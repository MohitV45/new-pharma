    ...
    <div className={`fixed inset-0 z-[9999] flex items-center justify-center bg-white transition-opacity duration-700 ${fading ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
      <div className="flex items-center justify-center">
        <div className="w-[200px] h-[100px] flex flex-col relative items-center justify-end overflow-x-hidden">
          {/* truck upper body */}
          <div className="w-[130px] h-fit mb-[6px] animate-[loader-motion_1s_linear_infinite]">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 198 93" className="w-full h-auto">
              <path strokeWidth={3} stroke="#282828" fill="#d97706" d="M135 22.5H177.264C178.295 22.5 179.22 23.133 179.594 24.0939L192.33 56.8443C192.442 57.1332 192.5 57.4404 192.5 57.7504V89C192.5 90.3807 191.381 91.5 190 91.5H135C133.619 91.5 132.5 90.3807 132.5 89V25C132.5 23.6193 133.619 22.5 135 22.5Z" />
          ...
          {/* truck's tires */}
          <div className="w-[130px] h-fit flex items-center justify-between px-[15px] pl-[15px] pr-[10px] absolute bottom-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" className="w-6 h-auto">
          ...
          <div className="w-full h-[1.5px] bg-[#282828] relative bottom-0 self-end rounded-[3px] after:content-[''] after:absolute after:w-[10px] after:h-full after:bg-[#282828] after:-right-1/2 after:rounded-[3px] after:animate-[loader-road_1.4s_linear_infinite] after:border-l-[4px] after:border-white before:content-[''] before:absolute before:w-[20px] before:h-full before:bg-[#282828] before:-right-[65%] before:rounded-[3px] before:animate-[loader-road_1.4s_linear_infinite] before:border-l-[10px] before:border-white" />
          <svg xmlSpace="preserve" viewBox="0 0 453.459 453.459" xmlns="http://www.w3.org/2000/svg" fill="#000000" className="absolute bottom-0 -right-[90%] h-[90px] animate-[loader-road_1.4s_linear_infinite]">
